...
//
    ...
    struct NearbyResultsModel : Codable {
        ...
        var woloo_type: String? = ""
        var is_open: Int?
        var timeByBike: String? = ""
        var timeByWalk: String? = ""
        var timeByCar: String? = ""
        ...
        enum CodingKeys: String, CodingKey {
            ...
            case woloo_type = "woloo_type"
            case is_open = "is_open"
            case timeByBike = "timeByBike"
            case timeByWalk = "timeByWalk"
            case timeByCar = "timeByCar"
...
class WahCertificate : Codable {
    
    var status: Int?
    var woloo: WahCertificateDetail?
    
}

class WahCertificateDetail : Codable {
