...
enum HistoryType : String, CaseIterable {
    ...
    case ManualCredit = "Manual Credit"
    case PowderRoomUsageCoins = "Powder room usage coins"
    ...
    var historyImage : UIImage {
        ...
        case .ManualCredit:
            return UIImage(named: "icon_manual_credit") ?? #imageLiteral(resourceName: "woloo_default")
            
        case .PowderRoomUsageCoins:
            return UIImage(named: "AddCoins") ?? #imageLiteral(resourceName: "woloo_default")
