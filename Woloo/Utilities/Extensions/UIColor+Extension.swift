...
extension UIColor {
    ...
    convenience init?(hexString: String?) {
        ...
        guard input.rangeOfCharacter(from: hexCharacterSet.inverted) == nil else {
            // Invalid hex string (contains non-hex characters like "yellow", "black", etc.)
            return nil
        }
        ...
        case 8 /* #AARRGGBB */:
            ...
            break
        default:
            // Invalid length - return nil instead of throwing exception
            return nil
        }
