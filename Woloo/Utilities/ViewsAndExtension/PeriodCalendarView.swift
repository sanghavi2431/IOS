...
public struct PeriodType {
    static let Period = PeriodItem(title: "Normal Day", color: "#f7eb30", innerColor: "#edcf61", icon:nil)
    static let Menstruation = PeriodItem(title: "Menstruation", color: "#F1779B", innerColor: "#fee8e9", icon: UIImage(named: "menstrual_cup.png"))
    static let Ovulation = PeriodItem(title: "Ovulation", color: "#B0C8E8",innerColor: "#dff5f6", icon: UIImage(named: "fertilization.png"))
    static let Pregnancy = PeriodItem(title: "Pregnancy", color: "#DFA7CC",innerColor: "#fcedde", icon: UIImage(named: "fetus.png"))
}
