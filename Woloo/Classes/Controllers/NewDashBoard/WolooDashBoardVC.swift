...
//        case locationDetail
    ...
    override func viewWillAppear(_ animated: Bool) {
       ...
       // getBloagsAndCategoryAPI(selectedCategory)
        ...
        for index in self.objBlogDetailModel.categories.indices {
            if self.objBlogDetailModel.categories[index].isSelected == true {
                self.objBlogDetailModel.categories[index].isSelected = false
            }
        }
    }
