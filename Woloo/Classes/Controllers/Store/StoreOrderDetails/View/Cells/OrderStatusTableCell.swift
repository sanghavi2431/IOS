...
class OrderStatusTableCell: UITableViewCell {
    ...
    func configureOrderStatusTableCell(objOrders: Orders?){
        
        self.objOrders = objOrders ?? Orders()
...
extension OrderStatusTableCell: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.configureNewOrderStatusCollectionCell(indexPath: indexPath, objOrder: objOrders)
