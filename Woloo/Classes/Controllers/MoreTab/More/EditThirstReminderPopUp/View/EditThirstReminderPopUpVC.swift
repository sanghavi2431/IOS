...
class EditThirstReminderPopUpVC: UIViewController {
    ...
    @IBOutlet weak var bellImgAnimation: UIImageView!
...
//imgVWRefer.image = UIImage.gifFromAsset(named: "refer_a_host")
    func loadInitialSettings(){
        
        
        self.bellImgAnimation.image = UIImage.gifFromAsset(named: "thirst_reminder_animation")
