...
struct SearchWolooViewModel{
    ...
    func searchWoloo(strQuery: String?,page: Int?, lat: Double?, long: Double?){
        
        WolooHostAPI().searchWolooHost(strQuery: strQuery ?? "", page: page ?? 0, lat: lat ?? 0.0, long: long ?? 0.0) { objCommonWrapper in
