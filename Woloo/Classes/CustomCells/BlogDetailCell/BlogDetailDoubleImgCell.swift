...
class BlogDetailDoubleImgCell: UITableViewCell {
...
//        self.imgVw2.layer.cornerRadius = 10
    ...
    func configureBlogDetailDoubleImgCell(objBlogModel: BlogModel?, currentIndexPath: IndexPath){
        ...
        if self.objBlogModel.mainImage?.count ?? 0 >= 2 {
