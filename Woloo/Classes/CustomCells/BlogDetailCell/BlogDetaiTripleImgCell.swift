...
class BlogDetaiTripleImgCell: UITableViewCell {
...
//        self.imgVw3.layer.cornerRadius = 10
    ...
    func configureBlogDetailTripleImgCell(objBlogModel: BlogModel?, currentIndexPath: IndexPath){
        ...
        if self.objBlogModel.mainImage?.count ?? 0 >= 3 {
