...
//        backgroundView?.bringSubviewToFront(yellowImage)
    ...
    override func layoutSubviews() {
        ...
        if selectionType == .middle {
            selectionView.layer.cornerRadius = 1.5
            selectionView.frame = CGRect(x: self.contentView.bounds.width/2, y: self.eventIndicator.center.y-3, width: 3, height: 3)
...
extension CustomCalenderCell: FSCalendarDelegateAppearance{
