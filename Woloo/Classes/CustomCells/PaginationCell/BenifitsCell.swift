...
class BenifitsCell: UICollectionViewCell {
    ...
    func setupCell() {
        ...
        let convertToBulletString = BulletPoints.shared.add(bulletList: bulletPointsArray, font: UIFont(name: "OpenSans-Bold", size: 12.0) ?? .systemFont(ofSize: 12.0),textColor: #colorLiteral(red: 1, green: 1, blue: 1, alpha: 1), bulletColor: #colorLiteral(red: 1, green: 0.9333333333, blue: 0, alpha: 1))
